...
//             Let's go with you on that journey to <span className='font-bold'>FINANCIAL FREEDOM.</span> We can't promise to solve all the problems 
//             or challenges that come your way this year but we promise to help you aquire the requisite knowledge in creating 
//             a financial plan, develop financial discipline and become financially intelligent- all at your own pace.
//           </p>
//         </div>
...
import React from 'react';
import { AiOutlineBulb, AiOutlineSetting, AiOutlineBarChart, AiOutlineDollarCircle, AiOutlineRocket, AiOutlineTool, AiOutlineSolution, AiOutlineRise, AiOutlineSmile, AiOutlineClockCircle, AiOutlineThunderbolt, AiOutlineTeam } from 'react-icons/ai';
    ...
    <section className="bg-gray-50 py-16 px-6 md:px-12 lg:px-24">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="space-y-8">
          {/* Module 1 */}
          <div className="bg-white shadow-md rounded-lg p-6 flex items-start gap-6">
            <AiOutlineDollarCircle className="text-green-500 text-5xl" />
            <div className="text-left">
              <h3 className="text-2xl font-semibold">Financial Literacy</h3>
              <p className="text-gray-600 mt-2">
                Learn how to manage your finances effectively, make smart investment decisions, and achieve financial stability.
              </p>
            </div>
          </div>
          ...
          {/* Module 8 */}
          <div className="bg-white shadow-md rounded-lg p-6 flex items-start gap-6">
            <AiOutlineClockCircle className="text-gray-500 text-5xl" />
            <div className="text-left">
