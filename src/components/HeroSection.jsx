...
//           >
//             <button 
//               className='bg-yellow-500  text-darkBlue mt-6 px-6 py-3 rounded-lg text-lg font-semibold z-10 relative'
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Registration Button */}
          <motion.a
            href="https://selar.co/m/teensvoiceacademy" // External link or path to your course page
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            <button 
